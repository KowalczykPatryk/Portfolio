...
function ProfilePictureBox({imagePathName, fullName, socialRoles}: ProfilePictureBoxProps): React.JSX.Element 
{
    ...
    return (
        <>
            <div className="flex flex-col gap-2 p-8 sm:flex-row sm:items-center sm:gap-6 sm:py-4 rounded-xl bg-white shadow-md">
                <img className="mx-auto block h-24 rounded-full sm:mx-0 sm:shrink-0 border-4 border-double" src={imagePathName} alt="profile image" />
